...
<div class="flex justify-between mt-5 mb-5 ml-5 mr-5 px-5">
	...
	<h2 class="text-4xl"><b>Tasks</b></h2>
	...
	<div>
		<form method="post" class="flex space-x-2">
			...
			<input name='search' type='text' required='true' class="rounded w-full" id="search" placeholder="Search Summary">
			<a>
	...
	<a href = "{{ route('tasks.create') }}" id="createTask">
		<img src = "images/add.svg" style="width:40px;height:40px;" id="createTask">
	</a>

</div>

<div class="mt-5 mb-5">
	<table class="shadow-xl bg-black-500 flex-shrink w-full" id="taskTable">
		<thead class="font-black bg-blue-100 border text-center">
			<tr>
				...
				<th class="px-24 py-5">PROJECT NAME</th>
				<th class="px-10 py-5">CREATED BY</th>
				<th class="px-10 py-5">ASSIGN TO</th>
		...
		$.ajax({
			...
			success: function(output){
				if(output != null){
					...
					$("#taskTable tbody").html(output);
				}
				else{
					var tr_str = "<tr>" +
						"<td>No record found.</td>" +
						"</tr>";
						$("#taskTable tbody").html(tr_str);
					}
				}
			});
		}
